    ...
    stages {
        ...
        stage('Upload to Nexus') {
            steps {
                // Deploy to Nexus
                sh 'pwd'
                nexusArtifactUploader artifacts: [[artifactId: 'SimpleWebApplication', classifier: '', file: 'target/SimpleWebApplication.war', type: 'war']], credentialsId: 'nexus', groupId: 'com.maven.bt', nexusUrl: ' http://172.31.1.152:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'http://172.31.1.152:8081/repository/maven-jenkins-releases/', version: '9.1.14'
